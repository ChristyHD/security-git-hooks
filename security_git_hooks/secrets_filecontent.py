...
def repository_yaml_check(repository_yaml):
    ...
    with open(repository_yaml, "r") as file:
        filey = yaml.safe_load(file)
        if filey["repoVisibility"] == "public_0C3F0CE3E6E6448FAD341E7BFA50FCD333E06A20CFF05FCACE61154DDBBADF71":
            return PUBLIC_RULES
        elif filey["repoVisibility"] == "private_12E5349CFB8BBA30AF464C24760B70343C0EAE9E9BD99156345DD0852C2E0F6F":
